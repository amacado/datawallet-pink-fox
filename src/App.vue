    ...
    <div id="app">
      ...
      <!--
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Datawallet Pink Fox App</a>
...
<script>
  import DatawalletLogin from "@/components/DatawalletLogin";
  export default {
    components: {DatawalletLogin}
  }
</script>